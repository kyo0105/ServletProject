...
<form name="f" id="f" action="regStep2.do" method="post">
...
function goCheckByPhone() {
	window.open('phoneAuth.do', 'phoneAuth', 'width=500, height=450, left=700, top=0, toolbar=no, directories=no, scrollbars=no, resizable=no, status=no, menubar=no');
	return;
}
