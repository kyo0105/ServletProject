                ...
                <article class="join-area">
                    <div class="join-step2">
                        ...
                        <div class="myinfo-wrap">
                            <div class="form">
                            <form name="frm" id="frm" action="regStep2Proc.do" method="post">
								<input type="hidden" name="birth" id="birth" value="">
								<input type="hidden" name="idDupChk" id="idDupChk" value="">
                                ...
                                <dl>
                                    ...
                                    <dd>
                                        <div class="form-item name">
                                            <input type="text" placeholder="" id="name" name="name" value="${ param.name }" disabled="disabled">
                                        </div>
                                    </dd>
                                </dl>
                                <dl>
                                            ...
                                            <div class="form-item birth">
                                                <div class="chk-wrap">
                                                    <div class="chk-box selected">
                                                        <input type="radio" name="birth_fl" id="birth_s" value="1" checked="checked">
                                                        <label class="checkbox" for="birth_s"></label>
                                                        <label for="birth_s">양력</label>
                                                    </div>
                                                    <div class="chk-box">
                                                        <input type="radio" name="birth_fl" id="birth_m" value="0">
                                    ...
                                    <dd>
                                        <div class="form-group v2">
                                            <div class="form-item">
                                                ...
                                                <input type="text" name="tel2" id="tel2" maxlength="4" value="${ param.tel2 }" disabled="" class="i_text" onkeyup="checkNum($(this), '숫자만 입력해주세요.');" title="휴대전화번호">
                                                <input type="text" name="tel3" id="tel3" maxlength="4" value="${ param.tel3 }" disabled="" class="i_text" onkeyup="checkNum($(this), '숫자만 입력해주세요.');" title="휴대전화번호">
                                                <br>
                                    ...
                                    <dd>
                                        <div class="form-group v2">
                                            <div class="form-item gender">
                                                <div class="chk-wrap">
                                                	<div class="chk-box selected">
														<input type="radio" name="sex" id="sex_n" value="없" checked="checked">
														<label class="checkbox" for="sex_n"></label> 
														<label for="sex_n">정보제공 안함</label>
													</div>
                                                    <div class="chk-box">
                                                        <input type="radio" name="sex" id="sex_m" value="남">
                                                        <label class="checkbox" for="sex_m"></label>
                                                        <label for="sex_m">남성</label>
                                                    </div>
                                                    <div class="chk-box">
                                                        <input type="radio" name="sex" id="sex_f" value="여">
...
// 전화번호
var tel = [$("#tel1").val(), $("#tel2").val(), $("#tel3").val()].join('-'); 
$("#tel").val( tel );

// 생년월일
var birth = "${ param.rrn1 }";
var gender = ${ param.rrn2 };

var bYear = parseInt( birth.substring(0, 2) );
var bMonth = birth.substring(2, 4);
var bDay = birth.substring(4, 6);
var before = [1, 2, 5, 6];
var after = [3, 4, 7, 8];

// 1900년대, 2000년대 구분
if(before.includes(gender)) bYear += 1900;
else if(after.includes(gender)) bYear += 2000;
...
var age = tYear - parseInt($("#byear").val());
