		...
		<div class="main">
			...
			<article class="article delivery-area">
				<div class="inner-box">
					<div class="item-wrap v2">
						...
						<div class="item">
							<a href="https://web.dominos.co.kr/quickOrder/index" onMouseDown="eval('try{ _trk_clickTrace( \'EVT\', \'메인 화면 > 퀵오더 주문하기\' ); }catch(_e){ }');">
			...
			<article class="article grade-area">
				<div class="inner-box">
					...
					<c:if test="${ not empty member }">
						<div class="user-info">
							...
							<div class="btn-wrap">
								...
								<a href="/mypage/myOrderList" class="btn-type5">주문내역</a>
							</div>
						</div>
					</c:if>
					<!--로그인 후: emp-->
					...
					<div>
								<a href="login.do"><img src="https://cdn.dominos.co.kr/domino/pc/images/main/main_card1.png"/></a>
							</div>
							<div>
