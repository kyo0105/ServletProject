						...
						<div class="menu-nav-wrap">
							<div class="menu-nav">
								<ul>
									...
									<li><a onclick="delete()" href="newsDelete.do?type=${param.type}&notice_code=${vDto.notice_code}">공지삭제</a></li>
									</c:if>
								</ul>
							</div>
						</div>
...
function noticeView(pSeq, pNoticeCode){
	...
	var pSearchCondition = '${param.searchCondition}';
...
function noticeEdit(pNotice_code){
	location.href = 'newsEdit.do?type=' + '${param.type}' + '&notice_code=' + pNotice_code + '&seq=' + '${param.seq}' + 
					'&currentPage=' + '${currentPage}' + '&searchCondition=' + '${param.searchCondition}' + 
					'&searchWord=' + '${param.searchWord}' + '&totalRecords=' + '${param.totalRecords}';
}
...
function noticeList(){
	var viewForm = $('<form></form>');
	viewForm.attr('action', 'newsList.do?type=' + '${param.type}');
	viewForm.attr('method', 'post');
	
	viewForm.append($('<input/>', {type: 'hidden', name: 'type', value: '${param.type}'}));
	viewForm.append($('<input/>', {type: 'hidden', name: 'currentPage', value: '${currentPage}'}));
